...
class LoginViewModelUnitTest {
    ...
    @Test
    fun alHacerClickEnBotonLogin_conCredencialesValidas_llamaRepositorioEInvocaCallback() = runTest {
    ...
    @Test
    fun alHacerClickEnBotonLogin_conCredencialesInvalidas_estableceMensajeDeError() = runTest {
    ...
    @Test
    fun alHacerClickEnBotonLogin_eliminaEspaciosEnBlancoDeLasCredenciales() = runTest {
